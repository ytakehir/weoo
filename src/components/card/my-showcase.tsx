...
export function MyShowcase({ posts, isLatest, onLatest, isPosted }: Props) {
    ...
    <div className={cn('flex w-full flex-col', zenmaru.className)}>
      <div className='flex w-full items-center gap-x-4 pb-10'>
        <div className='inline-grid *:[grid-area:1/1]'>
          <div className='status status-lg status-secondary animate-ping' />
          <div className='status status-lg status-secondary' />
        </div>
