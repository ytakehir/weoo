...
const FAQ_ITEMS = [
  {
    ...
    question: 'お題って何ですか？',
    answer:
      'お題は「今日はこれをやってみよう！」というお題です。2人以上で楽しめる、ちょっと変わった遊びや体験を毎日お届けします。（毎日9時更新）',
    category: 'features'
  },
  {
    id: 'post',
  ...
  },
  {
    ...
    answer:
      '月額500円で全てのお題に参加でき、投稿・閲覧が無制限になります。初回は2週間の無料期間付きです。また、機能は少々制限されますが、30日間の無料トライアルもご用意しています',
    category: 'pricing'
  },
  {
    id: 'latest',
    question: '最新のお題はどうやって決まりますか？',
    answer: '未使用のお題、または1ヶ月以上経過したお題からランダムに選ばれます。毎日違う発見があるようにしています。',
    category: 'features'
  },
  {
    id: 'photo',
  ...
  },
  {
    ...
    answer: 'はい。サイドバー内の「解約する」ボタンからいつでも解約できます。次回請求日まではサービスを利用できます。',
    category: 'pricing'
  }
]
