...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer: 'お題に挑戦して撮った写真をアップロードするだけでOKです。他の人の投稿も閲覧できたり、マイページに思い出として残ります。',
    category: 'features'
  },
  {
    id: 'pricing',
    question: '利用料金はいくらですか？',
    answer: '月額500円で全てのお題に参加でき、投稿・閲覧が無制限になります。初回は2週間の無料期間付きです。また、機能は少々制限されますが、1週間の無料トライアルもご用意しています',
    category: 'pricing'
  },
  {
    id: 'latest',
  ...
  },
  {
    ...
    answer: 'はい。サイドバー内の「Unsubscribe」ボタンからいつでも解約できます。次回請求日まではサービスを利用できます。',
    category: 'pricing'
  }
]
