...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer: 'お題に挑戦して撮った写真をアップロードするだけでOKです。他の人の投稿も一覧やギャラリーで楽しめます。',
    category: 'features'
  },
  {
    id: 'pricing',
    question: '利用料金はいくらですか？',
    answer: '月額500円で全てのお題に参加でき、投稿・閲覧・コメントが無制限になります。初回は1週間の無料体験付きです。',
    category: 'pricing'
  },
  {
    id: 'latest',
  ...
  },
  {
    ...
    answer: 'はい。マイページからいつでも解約できます。次回請求日まではサービスを利用できます。',
    category: 'pricing'
  }
]
