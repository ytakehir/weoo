...
const meta: Meta<typeof MyShowcase> = {
  component: MyShowcase
}

export default meta

export const Default: StoryObj<typeof MyShowcase> = {
  args: {
    posts: [
      {
        mission: (
  ...
  render: (args) => {
    ...
    return <MyShowcase {...args} isLatest={isLatest} onLatest={() => setIsLatest(!isLatest)} />
  }
}
